...
$range_date = sanitize_text_field( $_GET['range_date'] );
$num_adult = sanitize_text_field( $_GET['adults'] );
$num_child = sanitize_text_field( $_GET['children'] );
?>
                ...
                <div class="custom-container">
                    <div class="system-room">
                        <div class="row">
                                                ...
                                                <div class="item item-room-booking">
                                                    ...
                                                    <div class="content">
                                                        ...
                                                        <div class="ct-bottom">
                                                            <div class="input-group">
                                                                <button class="decrease" type="button">
                                                                    <img src="http://localhost/hotelhoabinh/wp-content/themes/anonymous/asset/icons/-.png" alt="">
                                                                </button>
                                                                <input id="numberAdults" name="count_room_<?php echo $item->ID; ?>" type="number" class="numberInput numberInputReset" value="0" min="0" max="<?php echo get_post_meta( $item->ID, 'limited_booking_room', true); ?>">
                            ...
                            <div class="col-4 item-bk">
                                <div class="book-now item-sticky">
